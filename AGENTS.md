...
- Classification: behavior → `references/` (directory = semantic responsibility, [ADR-0026](docs/design-decisions/ADR-0026-references-taxonomy.md)); knowledge → `docs/`; one ID = one file (`docs/README.md`).
