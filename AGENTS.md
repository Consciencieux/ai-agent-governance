...
| Artifact placement and object creation (owner routing) | `docs/README.md` § 东西放哪里 · § 类型目录封闭 · § 文档职责与信息密度 · `docs/findings/FINDING-0030-artifact-placement-routing-gap.md` | repo |
