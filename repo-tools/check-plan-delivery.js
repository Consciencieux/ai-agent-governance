...
const RUNTIME_ARTIFACTS = [
  ...
  [".governance/activity.jsonl", ["references/policies/governance-files.policy.md", "references/instruction/sub-skills.md"]],
  [".governance/state.json", ["references/instruction/sub-skills.md", "scripts/generate-governance.js"]],
  ...
  [".governance/generated/skills", ["references/instruction/sub-skills.md"]],
];
...
function candidatePaths(declared) {
  ...
  for (let c of out) {
    ...
    if (!c.includes("/")) {
      for (const home of ["references/templates", "references/instruction", "references/capabilities", "references/capabilities/subskills", "references/policies", "references/workflows", "scripts", "repo-tools", "repo-workflows", "tests", "docs", "docs/archive"]) {
    ...
    const RELOCATIONS = [
      ...
      [/^references\/templates\/sub-skills\.md$/, "references/instruction/sub-skills.md"],
      [/^references\/templates\/agents-md\.template\.md$/, "references/instruction/agents-md.template.md"],
      [/^references\/capabilities\/(subskill-[a-z0-9-]+\.md)$/, "references/capabilities/subskills/$1"]
    ];
