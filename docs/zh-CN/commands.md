...
| plan-manager | `plan this task` · `create task plan` · `update development plan` · `check off milestone` · `mark task completed` · `归档已完成计划` | 创建 TASK 计划、勾选里程碑、标记任务完成、发布时归档已完成计划 |
