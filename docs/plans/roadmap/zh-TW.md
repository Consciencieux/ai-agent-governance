...
當前階段：4 — Checker / Primitive restructuring
當前階段計劃：PLAN-0035（phase checkpoint；Active）。附屬：PLAN-0036（R24 Discovery Ledger payload）。Phase 3 已完成：PLAN-0034 已於 lifecycle closure 歸檔（`docs/plans/archive/`；Plan archive ≠ Release — ADR-0016）。Phase 3 baseline：`24021c4`。
