...
**Active** = [PLAN-0055](../PLAN-0055-gen1-carrier-absorb-and-retire.md)（Gen1 carrier 重裁 / 吸收 / retire + 測試瘦身，口徑 B；Stage 1R+3：最小必要面；已刪 2 個儀式腳本；下一步 consistency EXTRACT / Stage 4）。排隊 Design：[PLAN-0053](../PLAN-0053-v2.1.x-finding-patch-slice.md)（2.1.x Finding 補丁）；[PLAN-0054](../PLAN-0054-h3-runtime-research-design.md)（H3 邊界，遠）。[PLAN-0052](../archive/PLAN-0052-gen1-observation-sunset.md) **Archived**（Gen1 CI 觀測 sunset）。[PLAN-0051](../archive/PLAN-0051-v2.1.0-release-acceptance.md) **Archived**（`v2.1.0`）。H2d 已 Archived。H2c = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**。H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**。
