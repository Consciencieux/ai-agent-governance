...
**遷移階段已關閉：** Phase 0–8 EXITED；**`v2.0.0` 已發佈**（2026-09-12）。Plan archive ≠ Release（ADR-0016）。**目前工作帶 = ADR-0025 H2**（H2-front [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) **Archived**；H2a = [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) **Archived**；H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**；**H2c** = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**；**H2d** = [PLAN-0050](../archive/PLAN-0050-h2d-payload-portability.md) **Archived**）。H1（[PLAN-0037](../archive/PLAN-0037-governance-skill-extraction.md)）已 Archived。

H0（[PLAN-0045](../archive/PLAN-0045-post-2.0-doc-truth.md)）已歸檔。
...
| **H2** 控制面補完 | 執行序見 ADR-0025 決策 14：H2-0 → PLAN-0046 → a→b→c→d | [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) / [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) / [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) Archived；**H2c** = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**；**H2d** = [PLAN-0050](../archive/PLAN-0050-h2d-payload-portability.md) **Archived** | **H2d Archived**；post-2.1 見 Active |
| **H3** 執行期與科研 | L3、測量、注意力實驗；不擋 2.1 | Design = [PLAN-0054](../PLAN-0054-h3-runtime-research-design.md)（不升 Active） | 遠 |

### H0 已完成

**Active** = [PLAN-0055](../PLAN-0055-gen1-carrier-absorb-and-retire.md)（Gen1 carrier 重裁 / 吸收 / retire + 測/腳本重建，口徑 B；Stage 1R+3+4+4Q+4S+4D+**4E** 完成：Gen1 封存**已刪**；daily allowlist 凍結；H2b/c 階段停車場**已 retire**（`check:full` ≡ daily）；live 測 + consistency/generate 薄 CLI）。排隊 Design：[PLAN-0053](../PLAN-0053-v2.1.x-finding-patch-slice.md)（2.1.x Finding 補丁）；[PLAN-0054](../PLAN-0054-h3-runtime-research-design.md)（H3 邊界，遠）。[PLAN-0052](../archive/PLAN-0052-gen1-observation-sunset.md) **Archived**（Gen1 CI 觀測 sunset）。[PLAN-0051](../archive/PLAN-0051-v2.1.0-release-acceptance.md) **Archived**（`v2.1.0`）。H2d 已 Archived。H2c = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**。H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**。

已歸檔（H0 帶）：PLAN-0035 / 0036 / 0038-0044；H0 = [PLAN-0045](../archive/PLAN-0045-post-2.0-doc-truth.md)。Plan 保持單檔（`PLAN-xxxx-*.md`）。

H0 歸檔 = [PLAN-0045](../archive/PLAN-0045-post-2.0-doc-truth.md)（Archived）。
...
| H2a 殘留抽出 | [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md)（**Archived**）· 5c leftover Capability 葉 · [FINDING-0029](../../findings/FINDING-0029-lifecycle-name-concept-drift.md) · [FINDING-0028](../../findings/FINDING-0028-script-generation-disposition-gap.md)（L0 台帳 = [PLAN-0041](../archive/PLAN-0041-script-inventory.md)；腳本層 `retire` 重裁 = [PLAN-0055](../PLAN-0055-gen1-carrier-absorb-and-retire.md) **Active**） |
...
- **2.x 下一帶（H2）**：H2-front [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) 已 Archived；H2a = [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) **Archived**；H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**；**H2c** = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**；**H2d** = [PLAN-0050](../archive/PLAN-0050-h2d-payload-portability.md) **Archived**（ADR-0025 決策 14）。
...
- 不在 H1 清理或刪除 Gen1 腳本；不把 H1/H2/H3 寫成 v2.1/v2.2/v2.3 發佈門檻（ADR-0025 決策 9–11）
- 不新建第三份能力去向表（消費 script-inventory）
...
H1     PLAN-0037 跨專案 portable 提煉 — **Archived**（2026-09-13）
        ↓
H2     執行序 ADR-0025：H2-0 → PLAN-0046（Archived）→ PLAN-0047（H2a Archived）→ PLAN-0048（H2b Archived）→ PLAN-0049（H2c Archived）→ PLAN-0050（H2d Archived）
        ↓
