...
**迁移阶段已关闭：** Phase 0–8 EXITED；**`v2.0.0` 已发布**（2026-09-12）。Plan archive ≠ Release（ADR-0016）。**当前工作带 = ADR-0025 H2**（H2-front [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) 已 Archived；H2a = [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) **Archived**）。H1（[PLAN-0037](../archive/PLAN-0037-governance-skill-extraction.md)）已 Archived。H0（[PLAN-0045](../archive/PLAN-0045-post-2.0-doc-truth.md)）已归档。
