...
Deferred ≠ must-ship may fail to run. These items do not block release; 2.0 still requires the ADR-0024 usability gate.
...
- **2.0 skill:** an installable, directly usable INSTALLED must-ship slice ([ADR-0024](../../design-decisions/ADR-0024-gen2-product-freeze.md) usability gate); not “point at a carrier”; not a separate PLAN-0037 universal pack.
...
Generation 2 success is not primarily measured by "how many capabilities were added". The long-term criteria below are **not** the 2.0 skill-release gate; that gate is [ADR-0024](../../design-decisions/ADR-0024-gen2-product-freeze.md).
