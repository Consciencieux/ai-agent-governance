...
**Migration closed:** Phase 0–8 EXITED; **`v2.0.0` shipped** (2026-09-12). Plan archive ≠ Release (ADR-0016). **Current horizon = ADR-0025 H2** (H2-front [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) **Archived**; H2a = [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) **Archived**; H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**; **H2c** = [PLAN-0049](../PLAN-0049-h2c-machine-controls.md) **Active**). H1 ([PLAN-0037](../archive/PLAN-0037-governance-skill-extraction.md)) is Archived.
...
| 5 | [PLAN-0038](../archive/PLAN-0038-task-capability-routing.md) · [PLAN-0039](../archive/PLAN-0039-context-detector-dispatcher.md) · [PLAN-0040](../archive/PLAN-0040-capability-physical-projection.md) | Archived (checkpoint EXITED; 5a map · 5b resolve/CLI · 5c P0–P2 projection; leftover deferred) |
| 6 | [PLAN-0042](../archive/PLAN-0042-invariant-based-testing.md) | Archived (checkpoint EXITED; oracle inventory + routing negatives + seed CTRLs; full mechanical coverage still deferred) |
| 7 | [PLAN-0043](../archive/PLAN-0043-review-system-redesign.md) | Archived (checkpoint EXITED; Impl must-ship; System/Research repo-keep; routing N4) |

### Release record

| Item | Status |
| --- | --- |
| 8 Rebuild mandatory gates | [PLAN-0044](../archive/PLAN-0044-rebuild-mandatory-gates.md) Archived (checkpoint EXITED) |
...
| **H2** Control-plane completion | Execution order: ADR-0025 decision 14 — H2-0 → PLAN-0046 → a→b→c→d | [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) / [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) / [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) Archived; **H2c** = [PLAN-0049](../PLAN-0049-h2c-machine-controls.md) **Active** | **H2c Active** |
| **H3** Runtime and research | L3, measurement, attention experiments; does not block 2.1 | No Active Plan | Far |

### H0 done

**Active** = [PLAN-0049](../PLAN-0049-h2c-machine-controls.md) (H2c). H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**.
...
H0 archive = [PLAN-0045](../archive/PLAN-0045-post-2.0-doc-truth.md) (Archived).
...
| H2-front Instruction surface | [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) (**Archived**) |
| H2a Residue extract | [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) (**Archived**) · 5c leftover Capability leaves · [FINDING-0029](../../findings/FINDING-0029-lifecycle-name-concept-drift.md) · [FINDING-0028](../../findings/FINDING-0028-script-generation-disposition-gap.md) (L0 inventory = [PLAN-0041](../archive/PLAN-0041-script-inventory.md); `retire = ∅` today) |
| H2b Checkers and ledgers | [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) (**Archived**) · Remaining consistency clusters · principles-index #9 · [FINDING-0011](../../findings/FINDING-0011-adr-status-false-positive.md) · [FINDING-0019](../../findings/FINDING-0019-check-doc-consistency-meta-checker-monolith.md) · [FINDING-0021](../../findings/FINDING-0021-roadmap-checker-vacuous.md) · Discovery Ledger L2 · [FINDING-0022](../../findings/FINDING-0022-recursive-discovery-workset-gap.md) · [FINDING-0024](../../findings/FINDING-0024-metadata-projection-drift.md) · [FINDING-0030](../../findings/FINDING-0030-artifact-placement-routing-gap.md) §5 · ADR-0016 parser migration |
| H2c Cross-profile / machine Controls | [PLAN-0049](../PLAN-0049-h2c-machine-controls.md) (**Active**) · [FINDING-0001](../../findings/FINDING-0001-producer-product-governance-coupling.md) CONTROL-X · [FINDING-0002](../../findings/FINDING-0002-missing-governance-control-plane.md) · [FINDING-0025](../../findings/FINDING-0025-governance-sync-mapping-gap.md) · [FINDING-0026](../../findings/FINDING-0026-templates-instruction-source-mix.md) |
...
- **2.x next band (H2):** H2-front [PLAN-0046](../archive/PLAN-0046-instruction-surface-2.0-alignment.md) Archived; H2a = [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) **Archived**; H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**; **H2c** = [PLAN-0049](../PLAN-0049-h2c-machine-controls.md) **Active** (ADR-0025 decision 14).
...
H1     PLAN-0037 cross-project portable extract — **Archived** (2026-09-13)
        ↓
H2     Execution order ADR-0025: H2-0 → PLAN-0046 (Archived) → PLAN-0047 (H2a Archived) → PLAN-0048 (H2b Archived) → PLAN-0049 (H2c Active)→d
        ↓
