...
**Active** = [PLAN-0055](../PLAN-0055-gen1-carrier-absorb-and-retire.md) (Gen1 carrier re-adjudicate / absorb / retire + test/script rebuild, bar B; Stage 1R+3+4+4Q+4S+4D+**4E** done: Gen1 archives **deleted**; daily allowlist frozen; H2b/c stage parking lot **retired** (`check:full` ≡ daily); live tests + consistency/generate thin CLIs). Queued Design: [PLAN-0053](../PLAN-0053-v2.1.x-finding-patch-slice.md) (2.1.x Finding patch); [PLAN-0054](../PLAN-0054-h3-runtime-research-design.md) (H3 boundary, far). [PLAN-0052](../archive/PLAN-0052-gen1-observation-sunset.md) **Archived** (Gen1 CI observation sunset). [PLAN-0051](../archive/PLAN-0051-v2.1.0-release-acceptance.md) **Archived** (`v2.1.0`). H2d Archived. H2c = [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) **Archived**. H2b = [PLAN-0048](../archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**.
...
| H2a Residue extract | [PLAN-0047](../archive/PLAN-0047-h2a-residue-extraction.md) (**Archived**) · 5c leftover Capability leaves · [FINDING-0029](../../findings/FINDING-0029-lifecycle-name-concept-drift.md) · [FINDING-0028](../../findings/FINDING-0028-script-generation-disposition-gap.md) (L0 inventory = [PLAN-0041](../archive/PLAN-0041-script-inventory.md); script-layer `retire` re-adjudication = [PLAN-0055](../PLAN-0055-gen1-carrier-absorb-and-retire.md) **Active**) |
...
| H2c Cross-profile / machine Controls | [PLAN-0049](../archive/PLAN-0049-h2c-machine-controls.md) (**Archived**) · [FINDING-0001](../../findings/FINDING-0001-producer-product-governance-coupling.md) CONTROL-X · [FINDING-0002](../../findings/FINDING-0002-missing-governance-control-plane.md) · [FINDING-0025](../../findings/FINDING-0025-governance-sync-mapping-gap.md) · [FINDING-0026](../../findings/FINDING-0026-templates-instruction-source-mix.md) |
