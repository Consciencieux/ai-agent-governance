...
| plan | 计划 | 計劃 |
| archive | 归档 | 歸檔 |
| feature registry | Feature 登记 | Feature 登記 |
| architecture doc | 架构文档 | 架構文件 |
| rules | 规则 | 規則 |
| policy | 策略 | 策略 |
| protection | 保护 | 保護 |
| permission model | 权限模型 | 權限模型 |
| confirmation | 确认 | 確認 |
| approval | 批准 | 批准 |
| forbidden | 禁止 | 禁止 |
| forbidden translation | 禁止译法 | 禁止譯法 |
| rollback | 回滚 | 回滾 |
| backup | 备份 | 備份 |
| repository | 仓库 | 倉庫 |
| project | 项目 | 專案 |
...
| install | 安装 | 安裝 |
| freshness | 新鲜度 | 新鮮度 |
| translation freshness | 翻译新鲜度 | 翻譯新鮮度 |
| consistency | 一致性 | 一致性 |
...
| protected branch | 受保护分支 | 受保護分支 |
| license | 许可协议 | 授權條款 |
| markdown | Markdown | Markdown |
| header | 标题 | 標題 |
| section | 章节 | 章節 |
| section ID | 章节标识 | 章節標識 |
| separator | 分隔符 | 分隔符號 |
| anchor | 锚点 | 錨點 |
| language policy | 语言政策 | 語言政策 |
| developer-facing | 开发者面向 | 開發者面向 |
| agent-facing | Agent 面向 | Agent 面向 |
| bilingual | 双语 | 雙語 |
| trilingual | 三语 | 三語 |
| glossary | 术语表 | 術語表 |
| terminology gate | 术语门禁（已退役） | 術語門禁（已退役） |
