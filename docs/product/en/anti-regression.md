...
- **6-phase operating lifecycle** — Understand → Plan → Implement → Validate → Synchronize → Report; includes change hygiene, rule capture, and change classification (see [lifecycle.md](lifecycle.md))
