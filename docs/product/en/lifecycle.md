...
The full lifecycle also includes Change Hygiene (current/compatibility/history surface checks for high-impact changes) and the Discovery Ledger (known-issue closure workset on medium/large TASK plans); both are defined in the same policy.
