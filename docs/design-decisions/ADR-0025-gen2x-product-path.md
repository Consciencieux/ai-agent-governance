...
- Roadmap「当前阶段」= **H2**（H2-front [PLAN-0046](../plans/archive/PLAN-0046-instruction-surface-2.0-alignment.md) **Archived** 2026-09-13；H2a = [PLAN-0047](../plans/archive/PLAN-0047-h2a-residue-extraction.md) **Archived**；H2b = [PLAN-0048](../plans/archive/PLAN-0048-h2b-checkers-and-ledgers.md) **Archived**；下一步 **H2c**（尚无 Active Plan，待 Design））。H0 / H1 已 Archived。
- ADR-0018 继续约束历史 Phase 0–8 与 ID 编号规则；2.x 顺序提问指向本 ADR。
- PLAN-0037 已 Archived（2026-09-13 Stage D）；PLAN-0046 已 Archived（2026-09-13 Stage 3/4 + Y6）；PLAN-0047 已 Archived（2026-09-13 Stage 0–4）；PLAN-0048 已 Archived（2026-09-13 Stage 0–4；H2b）。下一步 H2c awaiting Design。
