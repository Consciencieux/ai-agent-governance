...
- Roadmap「当前阶段」= **H2**（H2-0 校准可立即小批；[PLAN-0046](../plans/PLAN-0046-instruction-surface-2.0-alignment.md) **Active**）。H0 / H1 已 Archived。
- ADR-0018 继续约束历史 Phase 0–8 与 ID 编号规则；2.x 顺序提问指向本 ADR。
- PLAN-0037 已 Archived（2026-09-13 Stage D）；PLAN-0046 已人类 Active（2026-09-13）。
